...
export default function PatientDetails() {
  ...
  const appointments = appointmentService.getByPatientId(id);
  ...
  const refreshPatient = () => {
    const updated = patientService.getById(id);
    setPatient(updated);
  };
  ...
  const handleDeleteVisit = (visitId) => {
    patientService.deleteVisit(id, visitId);
    refreshPatient();
  };
